...
1. Read `balatro://instances`, select an instance, and read its instance-scoped turn resource before each action.
...
- Small and Big Blind skip rewards are in the selected instance's `balatro://instances/{instance_id}/ante` resource. Weigh the tag against lost cash, shop access, and scaling — Boss Blinds cannot be skipped.
