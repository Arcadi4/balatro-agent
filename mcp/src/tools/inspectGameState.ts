...
import INSPECT_CARD_INSTANCE_DESCRIPTION from "./inspect-card-instance.txt" with { type: "text" };
import INSPECT_GAME_STATE_DESCRIPTION from "./inspect-game-state.txt" with { type: "text" };
