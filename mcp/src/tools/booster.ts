...
import OPEN_BOOSTER_DESCRIPTION from "./open-booster.txt" with { type: "text" };
import SELECT_BOOSTER_CARD_DESCRIPTION from "./select-booster-card.txt" with { type: "text" };
import SKIP_BOOSTER_DESCRIPTION from "./skip-booster.txt" with { type: "text" };
