...
import REROLL_SHOP_DESCRIPTION from "./reroll-shop.txt" with { type: "text" };
import LEAVE_SHOP_DESCRIPTION from "./leave-shop.txt" with { type: "text" };
import CASH_OUT_DESCRIPTION from "./cash-out.txt" with { type: "text" };
